...
net_arg.add_argument(
    "--clusters", type=int, default=250, help=""
    "cluster number in OA block. Default: 500")
net_arg.add_argument(
...
data_arg.add_argument(
    "--data_tr", type=str, default="/mnt/disk2/murmur/mynet/mynet/mynet_code/data_dump/yfcc-sift-2000-train.hdf5", help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default="/mnt/disk2/murmur/mynet/mynet/mynet_code/data_dump/yfcc-sift-2000-val.hdf5", help=""
    "name of the dataset for valid")
#data_arg.add_argument(
#    "--data_te", type=str, default="/home/hxg/datasets/dataset/yfcc/yfcc-sift-2000-test.hdf5", help=""
#    "name of the unseen dataset for test")    
data_arg.add_argument(
    "--data_te", type=str, default="/mnt/disk2/murmur/mynet/mynet/mynet_code/data_dump/yfcc-sift-2000-test.hdf5", help=""
    "name of the unseen dataset for test")
#data_arg.add_argument(
#    "--data_te", type=str, default="/home/zyf/code/NCMNet/data_dump/yfcc_rootsift/yfcc-rootsift-2000-test.hdf5", help=""
#    "name of the unseen dataset for test")
...
train_arg.add_argument(
    "--num_processor", type=int, default=4, help='numbers of used cpu')
train_arg.add_argument(
...
test_arg.add_argument(
    "--model_path", type=str, default="../code/log/train/", help=""
